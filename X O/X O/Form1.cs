...
namespace X_O
{
    public partial class Form1 : Form
    {
        ...
        public Form1(bool isHost, string port = null)
        {
            InitializeComponent();
            ...
            else
            {
                ...
                try
                {
                    client = new TcpClient(port, 5732);
                    sock = client.Client;
        ...
        {
            Xlabel.Text = SSScore.XScore.ToString();
            Olabel.Text = SSScore.OScore.ToString();
        }
